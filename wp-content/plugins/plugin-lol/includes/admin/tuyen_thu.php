...
add_action( 'plugins_loaded', array( 'cau_thu', 'init' ));
...
class cau_thu {
	...
	public function add_custom_product_option_type(){
		...
		$label = array(
			'name'                => _x( 'Cầu Thủ', 'Post Type General Name', 'twentythirteen' ),
			'singular_name'       => _x( 'Cầu Thủ', 'Post Type Singular Name', 'twentythirteen' ),
			'menu_name'           => __( 'Cầu Thủ', 'twentythirteen' ),
			'parent_item_colon'   => __( 'Parent Cầu Thủ', 'twentythirteen' ),
			'all_items'           => __( 'All Cầu Thủ', 'twentythirteen' ),
			'view_item'           => __( 'View Cầu Thủ', 'twentythirteen' ),
			'add_new_item'        => __( 'Add New Cầu Thủ', 'twentythirteen' ),
			'add_new'             => __( 'Add New', 'twentythirteen' ),
			'edit_item'           => __( 'Edit Cầu Thủ', 'twentythirteen' ),
			'update_item'         => __( 'Update Cầu Thủ', 'twentythirteen' ),
			'search_items'        => __( 'Search Cầu Thủ', 'twentythirteen' ),
			'not_found'           => __( 'Not Found Cầu Thủ', 'twentythirteen' ),
			'not_found_in_trash'  => __( 'Not found Cầu Thủ in Trash', 'twentythirteen' ),
		);
	...
	// 	$screens = array( 'cau_thu' );

	// 	foreach ( $screens as $cau_thu ) {
	// 		add_meta_box(
