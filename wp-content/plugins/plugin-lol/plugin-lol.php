...
class main {
	...
	public function includes(){
		...
		require_once plugin_dir_path( __FILE__ ).'includes/admin/'.'tuyen_thu.php';
		// //Menu Product Option set in Admin panel
		require_once plugin_dir_path( __FILE__ ).'includes/admin/'.'doi_tuyen.php';
	...
	public function frontend_script_css(){
		...
		// if(is_product()){
			...
			wp_enqueue_script( 'single_product_load',  untrailingslashit( plugins_url( '/', __FILE__ ) )."/assets/js/frontend/script_result.js" , array() , false , true );
		// }
	...
	public function declare_class(){
		//Declare class
		$tuyen_thu = new cau_thu();
		$doi_tuyen = new doi_tuyen();
